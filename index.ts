...
const sliderOutput = document.querySelector<HTMLParagraphElement>('.slider-output');
...
// generating grid
function generateGrid(gridResolution: number = 16) {
    const gridAreaElement = document.querySelector<HTMLDivElement>('.grid-area');
    ...
    const gridList = Array.from(document.querySelectorAll<HTMLDivElement>('.grid-element'));
